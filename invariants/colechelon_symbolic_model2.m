...
%%
%% PURPOSE
%%   Compute the number of quadratic invariants of Model 2 (K=2, M=5, sparse coupling)
...
%%
%% MODEL
%%   Gyrostat 1 on modes {x1,x2,x3}, gyrostat 2 on modes {x3,x4,x5}.
%%   The shared mode is x3. Parameters: p_k,q_k,r_k (nonlinear, with
%%   p_k+q_k+r_k=0) and a_k,b_k,c_k (linear feedback).
%%
%% METHOD
%%   Builds the 10x10 constraint matrix A from dC/dt=0, performs symbolic
%%   column echelon reduction, and reads off the invariant count
%%
%%
%% REQUIREMENTS: MATLAB Symbolic Math Toolbox
%%
%% OUTPUT
%%   A  -- constraint matrix (A9 is its final form after column reduction)
